  ...
  return (
    <div className="flex-1 flex flex-col bg-slate-50 overflow-y-auto">
      ...
      <div className="px-5 py-4 space-y-4">
        ...
        {/* Administration link */}
        <div className="bg-slate-100/80 border border-slate-200/80 rounded-2xl p-3 flex items-center justify-between">
          ...
          <a
            href="/admin"
            className="text-xs font-semibold text-brand-forest hover:text-brand-dark flex items-center space-x-1"
          >
