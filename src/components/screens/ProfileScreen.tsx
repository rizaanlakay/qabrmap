      ...
      <div className="px-5 py-4 space-y-4">
        ...
        {isAdmin && (
          <div className="bg-slate-100/80 border border-emerald-200/60 rounded-2xl p-3 flex items-center justify-between">
            ...
            <Link
              href="/admin"
              className="text-xs font-semibold text-emerald-800 hover:text-emerald-950 flex items-center space-x-1 bg-white px-2.5 py-1 rounded-lg border border-slate-200 shadow-xs transition-colors"
            >
